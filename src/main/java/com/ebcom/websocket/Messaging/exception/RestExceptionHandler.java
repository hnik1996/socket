package com.ebcom.websocket.Messaging.exception;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> notfoundException(HttpServletRequest request, BadRequestException ex) {
        ...
        errorDetails.put("message", ex.getMessage());
        if (ex.getResult() != null) errorDetails.put("result", ex.getResult());
        return new ResponseEntity<>(errorDetails, HttpStatus.BAD_REQUEST);
    }
